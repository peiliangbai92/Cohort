...
###
### All intermediates land in application/cache_v2/, tables in
### application/output_v2/, and publication PDFs in
### tex/Cohort_cp_detection_manuscript/images_v2/. The original cache/,
### output/, and images/ trees are untouched.
...
CACHE_V2 <- "application/cache_v2"
OUT_V2   <- "application/output_v2"
IMG_V2   <- "tex/Cohort_cp_detection_manuscript/images_v2"
...
if (sys.nframe() == 0L) {
    ...
    preproc   <- preproc_v2()
    intervals <- intervals_v2(preproc)
    ...
    cat("\n--- writing publication PDFs to images_v2/ ---\n")
    write_hist_v2        (fits)
